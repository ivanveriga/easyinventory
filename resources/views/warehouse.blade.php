...
<table class="w-75 ml-5 mt-3 com-section">
    ...
    <tbody class="m-5">
        @foreach ($computersWarehouse as $computer)
            <tr class="d-flex mt-3 mb-3" onclick="showModal('modal_computer_info_{{$computer->id}}')">
                        ...
                        <div class="m-5">
                            <div class="d-flex">
                                <div class="d-block col-10">
                                    <div class="w-50 ml-5 com-title"><p>Склад</p></div>
                                    <div class="d-flex ml-5 mt-2 pb-3 com-subtitle"><p>Компьютер</p></div>
                                </div>
        ...
        @endforeach
        <tr><td colspan="3"><div class="com-table-big-button pt-4 pb-4" onclick="showModal('modal_addComputer')">Добавить компьютер на склад</div></td></tr>
    </tbody>
</table>
...
<table class="w-75 ml-5 mt-3 com-section">
    ...
    <tbody class="m-5">
        @foreach ($thinclientsWarehouse as $thinclient)
            <tr class="d-flex mt-3 mb-3" onclick="showModal('modal_thinclient_info_{{$thinclient->id}}')">
        ...
        @endforeach
        <tr><td colspan="3"><div class="com-table-big-button pt-4 pb-4" onclick="showModal('modal_addThinClient')">Добавить тонкий клиент на склад</div></td></tr>
    </tbody>
</table>

<br><br><br>

<!-- Modal: Create new computer-->
<div id="modal_addComputer" class="com-modal-window">
    <div class="text-right mt-5 mr-5 mb-5 com-modal-close" onclick="hideModal('modal_addComputer')">⛌</div>
    <div class="d-flex justify-content-center mt-5">
        <div class="com-modal-section">
            <div class="w-50 ml-5 mt-5 com-title"><p>Склад</p></div>
            <div class="ml-5 mt-2 pb-3 com-subtitle"><p>Добавить компьютер</p></div>
            <div class="d-flex ml-5 mt-5 mb-5">
                <input class="w-25 mr-5" type="text" id="modal_addComputer_name" placeholder="Имя нового компьютера"> 
                <div class="ml-5 mb-3 com-table-button-add" onclick="createComputer()">↻</div>
            </div>
        </div>
    </div>
</div>

<!-- Modal: Create new thin client-->
<div id="modal_addThinClient" class="com-modal-window">
    <div class="text-right mt-5 mr-5 mb-5 com-modal-close" onclick="hideModal('modal_addThinClient')">⛌</div>
    <div class="d-flex justify-content-center mt-5">
        <div class="com-modal-section">
            <div class="w-50 ml-5 mt-5 com-title"><p>Склад</p></div>
            <div class="ml-5 mt-2 pb-3 com-subtitle"><p>Добавить тонкий клиент</p></div>
            <div class="d-flex ml-5 mt-5 mb-5">
                <input class="w-25 mr-5" type="text" id="modal_addThinClient_name" placeholder="Имя нового тонкого клиента"> 
                <div class="ml-5 mb-3 com-table-button-add" onclick="createThinClient()">↻</div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    /**
     * Ajax create computer and reload page
     * return location.reload
     */
    function createComputer() {
        data = {
            'computer_name' : $('#modal_addComputer_name').val()
        }
     ...
     * @param string $_computerId computer id
     * return location.reload
     */
    ...
    /**
     * Ajax create thin client and reload page
     * return location.reload
     */
    function createThinClient() {
        data = {
            'thinclient_name' : $('#modal_addThinClient_name').val()
        }
